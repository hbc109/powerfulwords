...
tab_recs, tab_upload, tab_library, tab1, tab_trends, tab_rv, tab_ew, tab2, tab3, tab_multi, tab_composite_bt, tab_tech_bt, tab_paper, tab_ai, tab_daily, tab_strategy, tab_method = st.tabs(
    ["Signal", "Upload", "Library", "Overview", "Trends", "Rel Value", "East-West", "Research",
...
with tab_ew:
    from app.rv.ew import render as _render_ew
    _render_ew()
